 ...
 * @param {import('../src/types/types.ts').ScatterPlotDatum[]} data - The data array for the scatter plot
 * @param {import('../src/types/types.ts').ScatterPlotOptions} opts - Configuration options for the chart
