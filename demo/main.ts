import { bg, fg } from "../src/utils/utils.ts";
import scatter, { type ScatterPlotDatum } from "../src/charts/scatter.ts";
import bar from "../src/charts/bar.ts";
import bullet from "../src/charts/bullet.ts";
import gauge from "../src/charts/gauge.ts";
import pie from "../src/charts/pie.ts";
